        ...
        <div className="navbar bg-[#ffbfd5]">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex="0" className="menu menu-compact dropdown-content shadow bg-base-100 rounded-box w-52">
                        <li className={`${location.pathname === '/' ? 'bordered' : ''} text-white`}><Link to='/'>Test</Link></li>
                    </ul>
                </div>
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu-horizontal px-1tabs">
                    <li className={`${location.pathname === '/' ? 'tab-active' : ''} tab tab-bordered text-white`}><Link to='/'>Test</Link></li>
                </ul>
            </div>
        </div>
    );
